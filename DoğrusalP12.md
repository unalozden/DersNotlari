...
9.  Probleme 2x1 + 7x2 10 kısıtlayıcısı eklenmektedir. Bu kısıtlayıcının
    eklenmesi yürürlükteki en iyi çözümü değiştirir mi? Açıklayınız.
>>>>>>> 7ecd5c3f9d56d999cdee1aa5219d458979b48be2
=======
## İKİNCİ BÖLÜM
...
ahşap doğranması gerektiğine göre, x2 adet çekmeceli sıra için 2x2 m3 ahşap
doğranmalıdır. İki ürün birlikte düşünüldüğünde doğranacak ahşap miktarı, 3x1 +
2x2 olur. En fazla 30 m3 ahşap doğranabildiğinden 3x1 + 2x2 $\le $ 30 yazılır.
...
çekmeceli sıra toplam x2 saatte birleştirilir. İki ürün birlikte düşünüldüğünde
toplam birleştirme zamanı 2x1 + x2 olur. Birleştirme bölümü bir günde en fazla
18 saat çalışılabildiğinden 2x1 + x2 $\le $ 18 olmalıdır. Böylece birleştirme
...
sıranın kontrolü x2 saatte tamamlanır. İki ürün birlikte düşünüldüğünde, toplam
birleştirme zamanı, x1 + x2 olur. Kontrol bölümü bir günde en fazla 14 saat
çalışılabildiğinden x1 + x2 $\le $ 14 olması gerekir. Böylece kalite kontrol
bölümünün günlük çalışma zamanı kapasitesi formüllenerek son kısıtlayıcı
belirlenmiş olur.

Üretim miktarları negatif olamayacağından, x1, x2 $\ge$ 0 yazılmasıyla problem
aşağıdaki gibi modellenmiş olur.

Zenb = 40x1 + 30x2

3x1 + 2x2 $\le $ 30 Makine zamanı kısıtlayıcısı

2x1 + x2 $\le $ 18 Birleştirme zamanı kısıtlayıcısı

x1 + x2 $\le $ 14 Kalite kontrol zamanı kısıtlayıcısı
...
içerir. Bu durumda x1 kg havuç, x2 kg ıspanak tüketildiğinde toplam 15x1 + 4x2
birim A alınmış olur. En az 60 birim A vitamini alınması gerektiğinden 15x1 +
4x2 $\ge$ 60 olur. Bu eşitsizlik A vitamini kısıtlayıcısıdır. Benzer şekilde B
vitamini kısıtlayıcısı,
...
Negatif tüketim söz konusu olamayacağına göre, x1, x2 $\ge$ 0 yazılmasıyla model
tamamlanmış, problem aşağıdaki gibi formüle edilmiş olur.

Zenk = 3x1 + 2x2

15x1 + 4x2 $\ge$ 60 A vitamini kısıtlayıcısı

10x1 + 15x2 $\ge$ 40 B vitamini kısıtlayıcısı

4x1 + 16x2 $\ge$ 32 C vitamini kısıtlayıcısı

x1, x2 $\ge$ 0

Kısıtlayıcılardaki $\ge$ işareti alınması gereken vitamin miktarlarının belirtilen
değerlerin altına düşmeyeceğini fakat, bu miktarlardan fazla olabileceğini
belirtmektedir.
...
x1 $\ge$ 0.20(80000) veya x1 $\ge$ 16000

1.  Altına yapılan yatırımın tahvile ayrılan paranın %10’undan fazla olmaması
    istenmektedir. Buna göre altın için ayrılan paranın x3, tahvile ayrılan
    paranın x4 olduğu dikkate alındığında, x3 $\le $ 0.10x4 yazılır.
...
8x1 + 5x2 + 2x3 + 3x4 $\le $ 5

1.  Toplam yatırım süresi ile ilgili sınırlama aşağıdaki gibi formüle edilir.

3x1 + 1x2 + 5x3 + 5x4 $\le $ 6

Negatif yatırım söz konusu olamayacağına göre, x1, x2, x3, x4 $\ge$ 0 yazılmasıyla
model tamamlanmış olur.
...
x1, x2, ..., xn $\ge$ 0 Negatif olmama koşulu 2.3
...
Genel olarak en büyükleme problemlerinin kısıtlayıcıları $\le $, en küçükleme
problemlerinin kısıtlayıcıları $\ge$ işaretli olurlar. Bununla birlikte,
kısıtlayıcılar $\le $, =, $\ge$ işaretli fonksiyonların herhangi bir karması da
olabilir.
...
grafikle açıklanmasıdır. Problem iki değişkenli olduğundan yatay eksen x1’e,
dikey eksen x2’ye karşılık gelmek üzere çözümün araştırılacağı koordinat sistemi
belirlenir. x1 ekseni x1 = 0, x2 ekseni x2 = 0’a karşılık gelmektedir. x1 $\ge$ 0,
x1’in sıfıra eşit veya sıfırdan büyük olduğunu gösterdiğinden, x1 ekseni ile bu
eksenin üst kısmı x1 $\ge$ 0 koşulunu sağlar. x2 $\ge$ 0, x2’nin sıfıra eşit veya
sıfırdan büyük olduğunu gösterdiğinden, x2 ekseni ile bu eksenin sağ tarafı x2
$\ge$ 0 koşulunu gerçekler. Böylece x1 $\ge$ 0, x2 $\ge$ 0 olmasını sağlayan bölge Şekil
...
Bu belirlemelerin ardından kısıtlayıcıların grafiği çizilir. Önce 3x1 + 2x2 $\le $
...
(0, 15) ve (10, 0) noktalarının birleştirilmesiyle 3x1 + 2x2 = 30 doğrusunun
çizimi tamamlanmış olur. Doğru üzerindeki bütün noktalar için 3x1 + 2x2 = 30
gerçekleşir. Analitik geometriden hatırlanacağı gibi $\le $ işaretli bir doğrusal
eşitsizlik bir doğru ile bu doğrunun altında kalan noktaları gösterir. Buna
göre, 3x1 + 2x2 $\le $ 30 eşitsizliğinin dikkate alınmasıyla uygun çözüm bölgesi
Şekil 2.2’deki OAB bölgesi olarak belirlenmiş olur. Sınırları da dahil olmak
üzere bu bölgedeki her nokta 3x1 + 2x2 $\le $ 30 kısıtlayıcısını sağlar. Şekil
2.2’nin ortaya koyduğu gibi x1 $\ge$ 0, x2 $\ge$ 0 kısıtlayıcısıyla belirlenen sonsuz
çözüm bölgesi, 3x1 + 2x2 $\le $ 30’un dikkate alınmasıyla OAB alanına
indirgenmiştir.
...
2x1 + x2 = 18 eşitliğinde, x1 = 0 için x2 = 18; x2 = 0 için x1 = 9 olduğundan,
doğrunun x1 ekseninin kestiği noktanın koordinatları (9, 0), x2 eksenini kestiği
noktanın koordinatları (0, 18) olarak belirlenir. Söz konusu kısıtlayıcı $\le $
işaretli olduğundan, bu doğru ve altında kalan her nokta eşitsizliği sağlar.

x1 + x2 = 14 eşitliğinde, x1 = 0 için x2 = 14; x2 = 0 için, x1 = 14 olduğundan,
doğrunun x1 ekseninin kestiği noktanın koordinatları (14, 0); x2 eksenini
kestiği noktanın koordinatları (0, 14) olur. Bu kısıtlayıcı da diğer kısıtlayıcı
gibi $\le $ işaretli olduğundan, bu doğru ve altında kalan her nokta eşitsizliği
sağlar.

Belirlenen noktaların birleştirilmesiyle, 2x1 + x2 = 18 ve x1 + x2 = 14
doğrularının çizimleri tamamlanmış olur. 3x1 + 2x2 $\le $ 30 kısıtlayıcısı da dahil
olmak üzere, tüm eşitsizliklerin yönünün dikkate alınmasıyla uygun çözüm bölgesi
Şekil 2.3’deki OABCD çok kenarlısı olarak belirlenmiş olur.
...
**Çözüm 2.5**: Önce uygun çözüm bölgesinin bulunacağı koordinat sistemini
belirleyelim. x1, x2 $\ge$ 0 olduğundan çizim birinci kuadrant üzerinde
...
Doğru üzerindeki bütün noktalar için 15x1 + 4x2 = 60 olur. Analitik geometriden
hatırlanacağı gibi eşit büyük şeklindeki bir doğrusal eşitsizlik bir doğru ile
bu doğrunun üstündeki noktaları gösterir. Buna göre, 15x1 + 4x2 $\ge$ 60
eşitsizliğinin dikkate alınmasıyla uygun çözüm bölgesi Şekil 2.4’deki gri alan
olarak belirlenir.

Şekil 2.4

Şimdi de B ve C vitamini kısıtlayıcılarının grafiklerini çizelim. 15x1 + 4x2 $\ge$
60, 10x1 + 15x2 $\ge$ 40 ve 4x1 + 16x2 $\ge$ 32 kısıtlayıcılarının hepsini aynı anda
...
**Çözüm 2.6**: Yukarıda açıklandığı gibi, simpleks yöntem problemin standart
formda yazılmasını gerektirdiğinden önce bu şartı yerine getirelim. Bunun için
$\le $ işaretli kısıtlayıcıları eşitlik biçiminde yazalım. 3x1 + 2x2 $\le $ 30
...
30 ise x3 = 0, 3x1 + 2x2 $\le $ 30 ise x3 eşitsizliğin iki tarafı arasındaki farka
eşittir. Bu nedenle x3’ün değeri 0 ile 30 arasında değişir. Benzer şekilde 2x1 +
x2 $\le $ 18 eşitsizliğinin sol tarafına x4, x1 + x2 $\le $ 14 eşitsizliğinin sol
...
Tablo 2.4’deki çözümde Z2 - C2 $\le $ 0 olduğundan çözüm en iyi değildir. Z’nin
değerini artırmak için x2 temele alınmalıdır. Temelden ayrılan değişkenin
belirlenmesi amacıyla hesaplanan oranlar Tablo 2.4’ün sağında gösterilmiştir. En
küçük oran x3 için hesaplandığından x3’ün temelden ayrılmasına karar verilir. x3
değişken satırı anahtar satır, x2 değişken sütunu anahtar sütun olduğundan
...
İkinci temel uygun çözümün bulunduğu Tablo 2.5’deki Zj - Cj değerlerinin ortaya
koyduğu gibi çözüm en iyi değildir. Z4 - C4 $\le $ 0 olduğundan, x4 temele
alınmalıdır. Temeli terkedecek değişkeni belirlemek için hesaplanan oranlar
Tablo 2.5’in sağında gösterilmiştir. En küçük oran x5 için hesaplandığından, x5
temeli terkedecektir. Anahtar sayının 1’e eşit olduğunun belirlenmesinin
ardından bilinen işlemlerin tekrarlanmasıyla yeni çözüm tablosu aşağıdaki gibi
...
programlama probleminin çözüm süreci en büyükleme probleminin çözüm süreciyle
aynıdır. Bu yüzden öncelikle problemin standart biçimde yazılması gerekir.
Problemin kısıtlayıcıları $\ge$ işaretlidir. Daha önce açıklandığı gibi, $\ge$
...
Tüm değişkenler negatif olmadığından, x1, x2,,x3, x4, x5 $\ge$ 0 olur.
...
Başlangıç tablosunun düzenlenmesinden sonra, çözümün en iyi olup olmadığının
kontrol edilmesi gerekir. Tüm Zj - Cj $\le $ 0 olmadığından, çözüm en iyi değildir.
Daha gelişmiş bir çözüm için bir değişkenin temelden çıkartılması başka bir
değişkenin temele alınması gerekir. Tanım gereği Z’yi en hızlı biçimde azaltacak
değişken temele alınacaktır. Z2 - C2 = 35M - 2 en büyük pozitif sayı olduğundan
x2 temele alınır.
...
Tablo 2.8’deki çözümün en iyi olup olmadığını kontrol edelim. Görüldüğü gibi, Z1
\- C1 = $\ge$ 0, Z5 - C5 olduğundan yürürlükteki çözüm en iyi değildir. Ayrıca, Z1 –
C1 $\ge$ Z2 – C2 olduğundan, x1 temele girer. Temelden ayrılan değişkenin
belirlenmesi için hesaplanan oranlar satır sırasına göre, 52/14, 40/25 ve 8’dir.
Enk(52/14, 40/25, 8) = 40/25 olduğundan A2’nin temeli terketmesi
kararlaştırılır. Buna göre, x1 değişken sütunu anahtar sütun, A2 değişken satırı
anahtar satır ve 25/4 anahtar sayı olur. Simpleks yöntemin anahtar işlemleriyle
...
Tablo 2.9’dan görüldüğü gibi, Z4 - C4, Z8 - C8 $\ge$ 0 olduğundan, henüz en iyi
çözüme ulaşılmamıştır. $\ge$ olduğundan, x4 temele alınır. A1 temelden çıkartılarak
bilinen anahtar işlemlerle aşağıdaki yeni (üçüncü) çözüm tablosu elde edilir.
...
Tablo 2.10’daki çözümde tüm Zj - Cj $\ge$ 0 olduğundan, çözüm en iyi olup x1 =
26/7, x2 = 15/14, x4 = 185/14 ve Zenk = 93/7 olarak belirlenmiştir.

Simpleks yöntemin son bir uygulaması olmak üzere, kısıtlayıcı fonksiyonları $\le $,
=, $\ge$ işaretli denklemlerin karması olan en küçükleme amaçlı bir doğrusal
...
**Çözüm 2.8**: Yukarıda açıklandığı gibi, öncelikle problemin simpleks çözümün
gerektirdiği forma dönüştürülmesi gerekir. Problemin $\le $ işaretli birinci
kısıtlayıcısına x4 aylak değişkenin eklenmesi, $\ge$ işaretli kısıtlayıcısından x5
artık değişkeninin çıkartılması, aynı kısıtlayıcıya A1 yapay değişkeninin
eklenmesiyle ilk iki kısıtlayıcı eşitlik formunda yazılmış olur. Zaten eşitlik
biçiminde olan son kısıtlayıcıya A2 yapay değişkeninin eklenmesiyle
kısıtlayıcılar aşağıdaki gibi elde edilir.
...
Tüm değişkenler negatif olmadığından, x1, x2, x3, x4, x5, A1, A2 $\ge$ 0 olur.
...
Z2 - C2 = 14M - 2 $\ge$ Z1 - C1 , Z3 - C3 olduğundan, x2 temele alınır. En küçük
oran A2 değişken satırında hesaplandığından A2 temelden çıkar. x2 değişken
sütununun anahtar sütun, A2 değişken satırının anahtar satır dolayısıyla,
anahtar sayının 6 olduğunun belirlenmesi ve simpleks yöntemin bilinen
işlemlerinin uygulanmasıyla elde edilen yeni (birinci) çözüm tablosu aşağıda
...
Görüldüğü gibi çözüm en iyi değildir. Z3 - C3 = 10M - 3 $\ge$ Z1 - C1 olduğundan,
x3 temele alınır. En küçük oran A1 değişken satırında hesaplandığından, A1
temelden çıkartılır. Simpleks yöntemin bilinen işlemleriyle düzenlenen yeni
(ikinci) çözüm tablosu aşağıda gösterilmiştir.
...
Tablo 2.13’den görüldüğü gibi tüm Zj - Cj $\le $ 0 olduğundan, en iyi çözüme
...
görüleceği gibi, Z1 - C1 $\le $ 0, Z2 - C2$\le $ 0 ve Z3 - C3 $\le $ 0 olduğundan çözüm en
iyi değildir. olduğundan, hem x1 hem de x3 temele girme koşulunu sağlamaktadır.
Bunlardan hangisinin temele gireceğini üçüncü yaklaşımla belirleyelim. Bu amaçla
hesaplanan oranlar, başlangıç çözüm tablosunun sağ tarafındaki sütunlarda
gösterilmiştir. En küçük oran (4/5) x1 için hesaplandığından x1 temele alınır,
...
Tüm Zj - Cj $\ge$ 0 olmadığından çözüm en iyi değildir. Z3 - C3 $\le $ Z2 - C2
olduğundan x3 temele girerken, en küçük değerli oranın hesaplandığı x1 temeli
...
Bütün Zj - Cj $\ge$ 0 olduğundan, tablodaki çözüm en iyi çözümdür. Buna göre, x1 =
0, x2 = 2/3, x3 = 2, x4 = 0, x5 = 0 ve Zenb = 124/3 olur.
...
oranlı satırlardaki her bir elemanı, bulunduğu satırın anahtar sütun üzerindeki
sayısına bölelim. Bu uygulamayla oranlar sırasıyla 1/10 ve 0/2 olarak
belirlenir. 0 $\le $ 1/10 olduğundan x5 temelden çıkartılır. Anahtar sütun ve
satırın belirlenmesinden sonra bilinen işlemlerle Tablo 2.19’a ulaşılır.
...
Z1 - C1 = -116 $\le $ 0 olduğundan çözüm en iyi değildir. Kural gereği, x1’in temele
alınması gerekir. Ancak, x1 giren değişken olduğunda bütün satırlar için negatif
değerli oranlar hesaplanacağından anahtar satır seçilemez. Bu durum, temel çözüm
için öngörülen x1 değişkeninin büyümesi yoluyla eldeki temel değişkenlerden
hiçbirinin daha da küçülemeyeceği ve dolayısıyla sıfır olamayacakları anlamına
...
**Çözüm 2.13**: Problemin grafik çözümü aşağıdaki şekilde gösterilmiştir. Şeklin
ortaya koyduğu gibi 3x1 + 6x2 $\le $ 6 kısıtlayıcısını sağlayan noktaları gösteren
taralı üçgen alan ile 6x1 + 3x2 $\ge$ 18 kısıtlayıcısını sağlayan noktaları
...
a11x1 + a12x2 + ... + a1nxn $\le $ b1

a21x1 + a22x2 + ... + a2nxn $\le $ b2

. . ... . .

am1x1 + am2x2 + ... + amnxn $\le $ bm
...
a11y1 + a21y2 + ... + am1ym $\ge$ C1

a12y1 + a22y2 + ... + am2ym $\ge$ C2

. . ... . .

a1ny1 + a2ny2 + ... + amnym $\ge$ Cn
...
kısıtlayıcı fonksiyonlarının sağ taraf sabitlerine eşit olacaktır. Primal
problem iki değişkenli olduğundan dual problemde iki kısıtlayıcı bulunacaktır.
Dual problemin kısıtlayıcıları $\ge$ işaretli olacaktır. Primal problemin teknoloji
matrisinin devriğinin göz önünde bulundurulmasıyla dual problem aşağıdaki gibi
modellenir.
...
problemde bu kısıtlayıcılara sırasıyla, y1, y2 ve y3 dual değişkenleri karşılık
gelecektir. Primal problem iki değişkenli olduğundan dual problemde iki
kısıtlayıcı bulunacaktır. Primal problemin kısıtlayıcıları $\ge$ işaretli
olduğundan dual problemin kısıtlayıcıları $\le $ işaretli olacaktır. Primal
...
biçiminde ($\ge$ işaretli) bir kısıtlayıcı varsa eşitsizliğin her iki tarafının -1
ile çarpılarak aşağıdaki gibi yazılmasıyla kısıtlayıcının işareti düzeltilmiş
olur.
...
biçiminde iki eşitsizlik kısıtlayıcısı yazılabilir. $\ge$ işaretli kısıtlayıcı -1
ile çarpılarak $\le $ işaretli kısıtlayıcıya dönüştürülür.
...
olacaktır. Primal problem iki kısıtlayıcılı olduğundan dual problem iki
değişkenli olacaktır. Primal problem dört değişkenli olduğundan dual problemde
$\ge$ işaretli dört kısıtlayıcı bulunacaktır. En büyükleme amaçlı doğrusal
programlama probleminin kısıtlayıcılarının $\le $ işaretli olması gerektiğinin göz
...
3x1 + 5x2 + 7x3 + 6x4 $\ge$ 91 ve 3x1 + 5x2 + 7x3 + 6x4 $\le $ 91

$\ge$ işaretli kısıtlayıcının her iki tarafının -1 ile çarpılmasıyla elde edilen
eşitsizlik aşağıda gösterilmiştir.

\-3x1 - 5x2 - 7x3 - 6x4 $\le $ -91

Üçüncü kısıtlayıcının her iki tarafının -1 ile çarpılmasıyla eşitsizliğin $\le $
işaretli olması sağlanır. Böylece primal problemin simetrik biçimde yazılmasıyla
ilgili düzenlemeler gerçekleştirilmiş ve problem aşağıdaki gibi elde edilmiş
olur.
...
Bu tutarsızlık, y1 ve y2 dual değişkenlerinin dikkate alınmasıyla tanımlanan
yeni bir değişkenin modele sokulmasıyla giderilebilir. y1 - y2 = y5 olsun. y1 $\ge$
0, y2 $\ge$ 0 olduğundan y5 sıfır, pozitif veya negatif olabilir. Bu yüzden y5
işareti kısıtlanmamış değişkendir. Dual problemde y1 - y2 = y5 değişikliğinin
...
y3, y4 $\ge$ 0, y5 işareti kısıtlanmamış

**Örnek 2. 17**: Aşağıdaki doğrusal programlama probleminin dualini yazınız.

Zenk = 3x1 + 14x2 + 6x3 + 9x4 + 5x5 - x6

x1 + x2 + x4 + x5 - 2x6 $\le $ 10

x2 + x3 + 3x4 + 12x5 + 7x6 = 71

2x3 + 4x4 + 6x6 $\le $ 38

x1 + 2x2 + 3x3 + 4x4 + 5x5 + 6x6 $\ge$ 77

x1, x2, x3, x4, x5 , x6 $\ge$ 0

**Çözüm 2.17**: Primal problem en küçükleme amaçlı olduğundan dual problem en
büyükleme amaçlı olur. Primal problemde dört kısıtlayıcı bulunduğundan dual
problemde dört değişken olacaktır. Primal problem altı değişkenli olduğundan
dual problemde altı kısıtlayıcı ($\le $ işaretli) bulunacaktır. En küçükleme
probleminin kısıtlayıcılarının $\ge$ işaretli olması gerektiğini göz önünde
bulundurarak primal problemin kısıtlayıcılarının gerektirdiği düzeltmeleri
yapalım.

$\le $ işaretli ilk kısıtlayıcıyı -1 ile çarparak işaretini, aşağıda gösterildiği
gibi, $\ge$ olarak düzeltelim.

\-x1 - x2 - x4 - x5 + 2x6 $\ge$ -10

İkinci kısıtlayıcı eşit işaretli olduğundan bu kısıtlayıcı yerine ($\le $ işaretli
olanı -1 ile çarparak) aşağıdaki iki kısıtlayıcıyı yazalım.

x2 +x3 + 3x4 + 12x5 + 7x6 $\ge$ 71

\-x2 - x3 - 3x4 - 12x5 - 7x6 $\ge$ -71

Primal problemin üçüncü kısıtlayıcısını -1 ile çarparak işaretini $\ge$ olarak
düzeltelim. Dördüncü kısıtlayıcı uygun biçimdedir.
...
\-y1 - 3y2 + 3y3 - 4y4 + 4y5 $\le $ 9

\-y1 -12y2 + 12y3 + 5y5 $\le $ 5

2y1 - 7y2 + 7y3 - 6y4 + 6y5 $\le $ -1

y1, y2, y3, y4, y5 $\ge$ 0

Dört değişkenli olması gereken dual problem (primaldeki = işaretli
kısıtlayıcının biri $\le $, diğeri $\ge$ işaretli iki kısıtlayıcı ile değiştirilmesi
sonucunda) beş değişkenli olmuştur. Bu tutarsızlığı gidermek için, Örnek
2.17’deki gibi, yeni bir değişken (y6) tanımlayalım. y6 = y2 - y3 olsun. Yerine
koyma ve gerekli düzenlemelerden sonra elde edilen dual problem aşağıda
gösterilmiştir.
...
2y1 - 7y6 - 6y4 + 6y5 $\le $ -1

y1, y4, y5 $\ge$ 0, y6 işareti kısıtlanmamış
...
**Çözüm 2.18**: Primal en büyükleme amaçlı olduğundan, dual en küçükleme amaçlı
olur. Primal problemin iki kısıtlayıcısına karşılık dual problem iki değişkenli
olur. Primal problem dört değişkenli olduğundan, dual problemde $\le $ işaretli dört
kısıtlayıcı bulunacaktır.
...
2(x- x) + 3(x- x) + 6(x- x) $\le $ 16

2(x- x) + (x- x) + (x- x) + (x- x) $\le $ 8

x, x, x, x, x, x, x, x$\ge$ 0

veya

Zenb = -6x+ 6x+ 36x- 36x+ 66x- 66x+ 6x- 6x

2x- 2x+ 3x- 3x + 6x- 6x $\le $ 16

2x- 2x+ x- x+ x- x+ x- x $\le $ 8

x, x, x, x, x, x, x, x$\ge$ 0

elde edilir.

Sekiz değişken ve $\le $ işaretli iki kısıtlayıcı fonksiyondan oluşan düzenlenmiş
primal problemin duali aşağıda gösterilmiştir.
...
eşit olduğu görülebilir. Bu tutarsızlığı gidermek için dual problem yeniden
düzenlenmelidir. Dual kısıtlayıcıların incelenmesinin ortaya koyduğu gibi, 2y1 +
2y2 $\ge$ -6 ve -2y1 - 2y2 $\ge$ 6 olarak formüllenen ilk iki kısıt yerine, 2y1 + 2y2
= -6, 3y1 + y2 $\ge$ 36 ve 3y1 - y2 $\ge$ -36 olarak formüllenen üçüncü ve dördüncü
kısıtların yerine, 3y1 + y2 = 36, y2 $\ge$ 66 ve -y2 $\ge$ -66 olarak formüllenen
beşinci ve altıncı kısıtlayıcılar yerine y2 = 66 yazılabilir. 6y1 + y2 $\ge$ 6 ve
\-6y1 - y2 $\ge$ -6 olarak formüllenen son iki kısıtlayıcının yerine 6y1 + y2 = 6
yazılmasıyla dual problem aşağıdaki gibi düzenlenir.
...
x1, x2 $\ge$ 0, x3 işareti kısıtlanmamış

**Çözüm 2.19**: Primal problem en büyükleme amaçlı olduğundan dual problem en
küçükleme amaçlı olur. Primal problemin iki kısıtlayıcısına karşılık dual
problemde iki değişken olacaktır. Primal üç değişkenli olduğundan dualde üç
kısıtlayıcı bulunacaktır. İkinci kısıtlayıcının işareti $\ge$ olduğundan ve işareti
kısıtlanmamış bir değişken bulunduğundan problem simetrik değildir. Öncelikle
simetrik biçimi oluşturalım. İşareti kısıtlanmamış x3 primal değişkenin yerine,
x- xyazalım. Problemde x3 = x- xkonulması ve $\ge$ işaretli kısıtlayıcının -1 ile
çarpılmasıyla,
...
Dört değişken ve $\le $ işaretli iki kısıtlayıcıya sahip düzenlenmiş primal
...
3y1 + 2y2 + y3 $\ge$ 40 3y1 + 2y2 + y3 - y4 + 0y5 + A1 + 0A2 = 40

2y1 + y2 + y3 $\ge$ 30 2y1 + y2 + y3 - 0y4 - y5 + 0A1 + A2 = 30

y1, y2, y3 $\ge$ 0 y1, y2, y3, y4, y5, A1, A2 $\ge$ 0
...
x1, yapay değişkenli 3y1 + 2y2 + y3 $\ge$ 40 dual kısıtlayıcıya karşılık
geldiğinden, x1 = Z6 - C6 (M = 0) olur. Dual problemin en iyi çözümünde; Z6 - C6
= 2(M = 0) olduğundan, x1 = 2’dir.

x2, yapay değişkenli 2y1 + y2 + y3 $\ge$ 30 dual kısıtlayıcıya karşılık
...
Temel değişkenlerin hepsi $\ge$ 0 olduğundan, yürürlükteki en iyi çözüm yine en
iyidir. Değişen yalnızca temel değişkenlerin değerleridir. Bu değişiklikler
altında, Zenb = 764/53 olur.
...
**Çözüm 2.24**: Bu değişiklik altında temel değişkenlerin yeni değerleri
aşağıdaki gibi hesaplanacaktır. x5 $\le $ 0 olduğundan en iyi çözüm, uygun olma
özelliğini yitirmiştir. Uygun en iyi çözüme ulaşmak için x5 temelden çıkmalıdır.
...
Z6 - C6 $\le $ 0 olduğundan, eldeki çözüm en iyi olma özelliğini yitirmiştir. x6’yı
temele alıp almama konusunda karar vermeden önce, x1, x2 ve x3 değişkenlerine
karşılık gelen Zj - Cj değerlerinin de hesaplanması gerekir.
...
katsayısındaki değişiklik bu değişkene karşılık gelen dual kısıtlayıcının sağ
tarafının değişmesine yol açar. Buna göre, x2’ye karşılık gelen dual kısıtlayıcı
3y1 + 4y2 + 7y3 $\ge$ 16 olur. y1 = 44/53, y2 = 0, y3 = 81/53 olduğu dikkate
alındığında dual kısıtlayıcının sağlanmadığı (699/53 13.2 $\le $ 16) görülecektir.
Bu durumda x2’ye karşılık gelen Z2 - C2 = 699/53 - 16 = -149/53 olur. Bu, en iyi
çözüm tablosunun Zj - Cj satırında rastlanacak olan tek değişikliktir ve x2’nin
temele alınmasıyla en iyi çözüme ulaşılabilir.
...
**Çözüm 2.27**: Temelde bulunmayan x2 değişkeninin teknoloji matrisindeki
katsayılarının değişmesi, Z2 - C2 değerinin değişmesine yol açar. Z2 - C2 $\ge$ 0
ise en iyi çözüm değişmez. Z2 - C2 $\le $ 0 ise x2 temele alınarak simpleks yöntemin
bilinen işlemleri uygulanır.

x2’nin teknolojik katsayıları değiştiğinden, x2’ye karşılık gelen dual
kısıtlayıcı 6y1 + 4y2 + 10y3 $\ge$ 8 olur. Simpleks çarpanların değerleri
değişmediğinden,

Z2 - C2 = 6(308/371) + 4(0) + 10(3969/2597)] - 8 = 31850/2597

olarak hesaplanır. Z2 - C2 $\ge$ 0 olduğundan eldeki en iyi çözüm hala en iyidir.
...
**Çözüm 2.28**: Bu özelliklere sahip x4’e karşılık gelen dual kısıtlayıcı
fonksiyon, 4y1 + 2y2 + y3 $\ge$ 2 olur. Simpleks çarpanların değişmediğini ve y1 =
308/371, y2 = 0, y3 = 3969/2597 olduğunu hatırlayalım. Bu değerler yeni dual
kısıtlayıcıya konulduğunda,

4(308/371) + 2(0) + 1(3969/2597) = 12593/2597 ( 4.85) $\ge$ 2
...
**Çözüm 2.29**: Bu özelliklere sahip x4’e karşılık gelen dual kısıtlayıcı
fonksiyon, 4y1 + 2y2 + y3 $\ge$ 6 olur. y1 = 308/371, y2 = 0, y3 = 3969/2597
değerleri yeni kısıtlayıcıdaki yerlerine konulduğunda,

4(308/371) + 2(0) + 1(3969/2597) = 12593/2597 ( 4.85) $\le $ 6

elde edilir. 4.85 $\le $ 6 olduğundan, dual kısıtlayıcının sağlanmadığı, x4
değişkenin temele alınmasının yürürlükteki çözümü geliştireceği kararlaştırılır.
x4’ün primal problemin en iyi çözüm tablosunda yol açtığı değişiklikler
aşağıdaki gibi belirlenecektir.
...
**Örnek 2.30**: Örnek 2.22’deki primal probleme 2x1 + 3x2 + 7x3 $\le $ 15 şeklindeki
yeni bir kısıtın eklenmesinin en iyi çözüm üzerindeki etkisini inceleyiniz.

**Çözüm 2.30**: Primal problemin en iyi çözümünde x1 = 124/53, x3 = 104/53, x2 =
0, olarak belirlenen değerler yeni kısıtlayıcıya yerleştirildiğinde, 976/53
(18.4) $\ge$ 15 olarak belirlenecektir. Yürürlükteki çözüm yeni kısıtlayıcı
fonksiyonu sağlamadığından artık uygun olmayacaktır. Bu durumda, diğer
kısıtlayıcı fonksiyonlarla birlikte, yeni eklenen kısıtlayıcı fonksiyonu da
sağlayan yeni bir çözümün araştırılması zorunludur.
...
3x1 + 2x2 $\ge$ 15 2x1 + 4x2 $\ge$ 8 x1 + x2 $\ge$ 3

6x1 + 3x2 $\ge$ 6 x1 + x2 $\ge$ 1 -x1 + x2 $\ge$ 1

x1 $\ge$ 4 x1 - x2 $\ge$ -1 2x1 - x2 $\ge$ 1

x1, x2 $\ge$ 0 x1, x2 $\ge$ 0 x1, x2 $\ge$ 0

**d**. Zenb = 2x1 + x2 **e**. Zenk = 2x1 + 4x2 **f**. Zenk = x1 + 5x2

\-x1 + 2x2 $\ge$ 4 x1 + 2x2 $\ge$ 10 2x1 + x2 $\ge$ 6

x1 - 2x2 $\ge$ 4 x2 $\ge$ 4 5x1 + 4x2 $\ge$ 20

3x1 + x2 $\ge$ 6 x1 + x2 $\ge$ 1 x1 + x2 $\ge$ 6

x1, x2 $\ge$ 0 x1, x2 $\ge$ 0 x1, x2 $\ge$ 0

**g**. Zenb = 3x1 - 2x2 **h**. Zenb = 3x1 + 2x2 **i**. Zenb = 5x1 + 2x2

2x1 - x2 $\ge$ 10 5x1 + 2x2 $\ge$ 10 6x1 + x2 $\le $ 6

6x1 - 3x2 $\ge$ 9 x1 + x2 $\ge$ 6 4x1 + x2 $\le $ 10
...
2x1 + 3x2 $\le $ 10 4x1 + 8x2 + 12x3 $\le $ 20

4x1 + 6x2 $\le $ 24 x1 + 9x2 + 3x3 $\le $ 5

3x1 + 8x2 $\le $ 40 4x1 + 8x2 + 12x3 $\le $ 20

x1, x2 $\ge$ 0 x1, x2, x3 $\ge$ 0

**iii**. Zenb = 7x1 + 8x2 + 8x3 + 6x4 **iv**. Zenb = 3x1 + 4x2 + 6x3

2x1 - 3x2 + 6x3 - 3x4 $\le $ 18 2x1 + x2 - 3x3 $\ge$ 12

4x1 + 6x2 + 5x4 $\le $ 32 3x1 + 4x2 + 4x3 $\le $ 14

3x1 + 8x2 + 4x3 $\le $ 40 x1 - 6x2 + 9x3 $\le $ 27

x1, x2, x3, x4 $\ge$ 0 x1, x2, x3 $\ge$ 0

**v**. Zenb = 18x1 + 36x2 + 18x3 **vı**. Zenk = 10x1 + 30x2

2x1 + 4x2 $\le $ 10 3x1 + 4x2 $\ge$ 12

x1 + x2 + x3 $\ge$ 16 4x1 + 8x2 $\ge$ 20

2x1 + 3x2 + 4x3 = 18 x1 + x2 $\ge$ 8

x1, x2, x3 $\ge$ 0 x1, x2 $\ge$ 0

**vii**. Zenk = 2x1 + x2 - 2x3 - 3x4 **viii**. Zenb = 3x1 + 14x2 - 5x3 + 14x4

x1 + 3x2 + 3x3 + 4x4 = 4 x1 + 2x2 + 8x3 + x4 $\ge$ 4

2x1 + 5x2 + 7x3 + x4 = 5 2x1 + 6x2 + 2x3 + 3x4 $\le $ 5

x1 + x2 + x3 = 6 4x1 + 5x2 + 9x3 = 20

x1, x2, x3, x4 $\ge$ 0 x1, x2, x3, x4 $\ge$ 0

**ix**. Zenk = 4x1 + 2x2 **x**. Zenk = 4x1 + 2x2 + 2x3 + x4

3x1 - 3x2 $\le $ 2 3x1 - 3x2 + 4x3 + 2x4 $\le $ 2

x1 + x2 $\le $ 5 x1 + x2 + x3 + 3x4 $\le $ 5

x1, x2 $\ge$ 0 x1, x2, x3, x4 $\ge$ 0

**14**. Zenb = 4x1 + 5x2 + 2x3 -3x4

4x1 + 2x2 + x3 $\le $ 20

3x1 + 4x2 + x3 + 4x4 $\ge$ 10

4x1 + 5x2 + x3 + x4 = 12, x1, x2, x3, x4 $\ge$ 0
...
9.  Probleme 2x1 + 7x2 $\le $ 10 kısıtlayıcısı eklenmektedir. Bu kısıtlayıcının
    eklenmesi yürürlükteki en iyi çözümü değiştirir mi? Açıklayınız.
>>>>>>> 7ccb85a21663ada947a0602e3d025ada6badb332:DoğrusalP12.md
