...
\- C1 = &\#8805; 0, Z5 - C5 olduğundan yürürlükteki çözüm en iyi değildir.
Ayrıca, Z1 – C1 &\#8805; Z2 – C2 olduğundan, x1 temele girer. Temelden ayrılan
değişkenin belirlenmesi için hesaplanan oranlar satır sırasına göre, 52/14,
40/25 ve 8’dir. Enk(52/14, 40/25, 8) = 40/25 olduğundan A2’nin temeli terketmesi
...
Tablo 2.9’dan görüldüğü gibi, Z4 - C4, Z8 - C8 &\#8805; 0 olduğundan, henüz en
iyi çözüme ulaşılmamıştır. &\#8805; olduğundan, x4 temele alınır. A1 temelden
...
Tablo 2.10’daki çözümde tüm Zj - Cj &\#8805; 0 olduğundan, çözüm en iyi olup x1
= 26/7, x2 = 15/14, x4 = 185/14 ve Zenk = 93/7 olarak belirlenmiştir.

Simpleks yöntemin son bir uygulaması olmak üzere, kısıtlayıcı fonksiyonları
&\#8804;, =, &\#8805; işaretli denklemlerin karması olan en küçükleme amaçlı bir
doğrusal programlama problemi çözelim.
...
gerektirdiği forma dönüştürülmesi gerekir. Problemin &\#8804; işaretli birinci
kısıtlayıcısına x4 aylak değişkenin eklenmesi, &\#8805; işaretli
kısıtlayıcısından x5 artık değişkeninin çıkartılması, aynı kısıtlayıcıya A1
yapay değişkeninin eklenmesiyle ilk iki kısıtlayıcı eşitlik formunda yazılmış
olur. Zaten eşitlik biçiminde olan son kısıtlayıcıya A2 yapay değişkeninin
eklenmesiyle kısıtlayıcılar aşağıdaki gibi elde edilir.
...
Tüm değişkenler negatif olmadığından, x1, x2, x3, x4, x5, A1, A2 &\#8805; 0
olur.
...
Z2 - C2 = 14M - 2 &\#8805; Z1 - C1 , Z3 - C3 olduğundan, x2 temele alınır. En
küçük oran A2 değişken satırında hesaplandığından A2 temelden çıkar. x2 değişken
...
Görüldüğü gibi çözüm en iyi değildir. Z3 - C3 = 10M - 3 &\#8805; Z1 - C1
olduğundan, x3 temele alınır. En küçük oran A1 değişken satırında
hesaplandığından, A1 temelden çıkartılır. Simpleks yöntemin bilinen işlemleriyle
düzenlenen yeni (ikinci) çözüm tablosu aşağıda gösterilmiştir.
...
Tablo 2.13’den görüldüğü gibi tüm Zj - Cj &\#8804; 0 olduğundan, en iyi çözüme
ulaşılmış ve en iyi çözüm, x1 = 0, x2 = 5/6, x3 = 7/3, x4 = 73/6, x5 = 0, A1 =
0, A2 = 0 ve Zenk = 26/3 olarak belirlenmiştir.
...
görüleceği gibi, Z1 - C1 &\#8804; 0, Z2 - C2&\#8804; 0 ve Z3 - C3 &\#8804; 0
olduğundan çözüm en iyi değildir. olduğundan, hem x1 hem de x3 temele girme
koşulunu sağlamaktadır. Bunlardan hangisinin temele gireceğini üçüncü yaklaşımla
belirleyelim. Bu amaçla hesaplanan oranlar, başlangıç çözüm tablosunun sağ
tarafındaki sütunlarda gösterilmiştir. En küçük oran (4/5) x1 için
hesaplandığından x1 temele alınır, x5 temelden çıkarılır.
...
Tüm Zj - Cj &\#8805; 0 olmadığından çözüm en iyi değildir. Z3 - C3 &\#8804; Z2 -
C2 olduğundan x3 temele girerken, en küçük değerli oranın hesaplandığı x1 temeli
...
Bütün Zj - Cj &\#8805; 0 olduğundan, tablodaki çözüm en iyi çözümdür. Buna göre,
x1 = 0, x2 = 2/3, x3 = 2, x4 = 0, x5 = 0 ve Zenb = 124/3 olur.
...
belirlenir. 0 &\#8804; 1/10 olduğundan x5 temelden çıkartılır. Anahtar sütun ve
...
Z1 - C1 = -116 &\#8804; 0 olduğundan çözüm en iyi değildir. Kural gereği, x1’in
temele alınması gerekir. Ancak, x1 giren değişken olduğunda bütün satırlar için
negatif değerli oranlar hesaplanacağından anahtar satır seçilemez. Bu durum,
temel çözüm için öngörülen x1 değişkeninin büyümesi yoluyla eldeki temel
...
ortaya koyduğu gibi 3x1 + 6x2 &\#8804; 6 kısıtlayıcısını sağlayan noktaları
gösteren taralı üçgen alan ile 6x1 + 3x2 &\#8805; 18 kısıtlayıcısını sağlayan
noktaları gösteren taralı sınırsız alanın hiçbir ortak noktası yoktur. Bu
durumda kısıtlayıcıları aynı anda sağlayan bir çözüm bölgesi bulunamadığından,
problemin uygun çözümü yoktur veya problemin uygun olmayan çözümü vardır denir.
Bu durumda bir en iyi çözümden söz edilemez.
...
a11x1 + a12x2 + ... + a1nxn &\#8804; b1

a21x1 + a22x2 + ... + a2nxn &\#8804; b2

. . ... . .

am1x1 + am2x2 + ... + amnxn &\#8804; bm
...
a11y1 + a21y2 + ... + am1ym &\#8805; C1

a12y1 + a22y2 + ... + am2ym &\#8805; C2

. . ... . .

a1ny1 + a2ny2 + ... + amnym &\#8805; Cn
...
Dual problemin kısıtlayıcıları &\#8805; işaretli olacaktır. Primal problemin
...
kısıtlayıcı bulunacaktır. Primal problemin kısıtlayıcıları &\#8805; işaretli
olduğundan dual problemin kısıtlayıcıları &\#8804; işaretli olacaktır. Primal
...
15y1 + 10y2 + 4y3 &\#8804; 3

4y1 + 15y2 + 16y3 &\#8804; 2
...
biçiminde (&\#8805; işaretli) bir kısıtlayıcı varsa eşitsizliğin her iki
...
biçiminde iki eşitsizlik kısıtlayıcısı yazılabilir. &\#8805; işaretli
kısıtlayıcı -1 ile çarpılarak &\#8804; işaretli kısıtlayıcıya dönüştürülür.
...
&\#8805; işaretli dört kısıtlayıcı bulunacaktır. En büyükleme amaçlı doğrusal
programlama probleminin kısıtlayıcılarının &\#8804; işaretli olması gerektiğinin
göz önünde bulundurulmasıyla primal problemin kısıtlayıcı fonksiyonlarını
...
3x1 + 5x2 + 7x3 + 6x4 &\#8805; 91 ve 3x1 + 5x2 + 7x3 + 6x4 &\#8804; 91

&\#8805; işaretli kısıtlayıcının her iki tarafının -1 ile çarpılmasıyla elde
edilen eşitsizlik aşağıda gösterilmiştir.

\-3x1 - 5x2 - 7x3 - 6x4 &\#8804; -91

Üçüncü kısıtlayıcının her iki tarafının -1 ile çarpılmasıyla eşitsizliğin
&\#8804; işaretli olması sağlanır. Böylece primal problemin simetrik biçimde
...
5y1 - 5y2 + 32y3 &\#8805; 15

7y1 - 7y2 + 6y3 - 2y4 &\#8805; 16
...
&\#8805; 0, y2 &\#8805; 0 olduğundan y5 sıfır, pozitif veya negatif olabilir. Bu
yüzden y5 işareti kısıtlanmamış değişkendir. Dual problemde y1 - y2 = y5
değişikliğinin yapılması ve gerekli düzenlemelerin gerçekleştirilmesiyle dual
problem aşağıdaki gibi elde edilir.
...
dual problemde altı kısıtlayıcı (&\#8804; işaretli) bulunacaktır. En küçükleme
probleminin kısıtlayıcılarının &\#8805; işaretli olması gerektiğini göz önünde
bulundurarak primal problemin kısıtlayıcılarının gerektirdiği düzeltmeleri
yapalım.

&\#8804; işaretli ilk kısıtlayıcıyı -1 ile çarparak işaretini, aşağıda
gösterildiği gibi, &\#8805; olarak düzeltelim.

\-x1 - x2 - x4 - x5 + 2x6 &\#8805; -10

İkinci kısıtlayıcı eşit işaretli olduğundan bu kısıtlayıcı yerine (&\#8804;
işaretli olanı -1 ile çarparak) aşağıdaki iki kısıtlayıcıyı yazalım.

x2 +x3 + 3x4 + 12x5 + 7x6 &\#8805; 71

\-x2 - x3 - 3x4 - 12x5 - 7x6 &\#8805; -71

Primal problemin üçüncü kısıtlayıcısını -1 ile çarparak işaretini &\#8805;
...
\-y1 + y2 - y3 + 2y5 &\#8804; 14

y2 - y3 - 2y4 + 3y5 &\#8804; 6

\-y1 - 3y2 + 3y3 - 4y4 + 4y5 &\#8804; 9

\-y1 -12y2 + 12y3 + 5y5 &\#8804; 5

2y1 - 7y2 + 7y3 - 6y4 + 6y5 &\#8804; -1

y1, y2, y3, y4, y5 &\#8805; 0

Dört değişkenli olması gereken dual problem (primaldeki = işaretli
kısıtlayıcının biri &\#8804;, diğeri &\#8805; işaretli iki kısıtlayıcı ile
değiştirilmesi sonucunda) beş değişkenli olmuştur. Bu tutarsızlığı gidermek
...
\-y1 - 3y6 - 4y4 + 4y5 &\#8804; 9

\-y1 - 12y6 + 5y5 &\#8804; 5

2y1 - 7y6 - 6y4 + 6y5 &\#8804; -1

y1, y4, y5 &\#8805; 0, y6 işareti kısıtlanmamış
...
olur. Primal problem dört değişkenli olduğundan, dual problemde &\#8804;
...
2(x- x) + 3(x- x) + 6(x- x) &\#8804; 16

2(x- x) + (x- x) + (x- x) + (x- x) &\#8804; 8

x, x, x, x, x, x, x, x&\#8805; 0

veya

Zenb = -6x+ 6x+ 36x- 36x+ 66x- 66x+ 6x- 6x

2x- 2x+ 3x- 3x + 6x- 6x &\#8804; 16

2x- 2x+ x- x+ x- x+ x- x &\#8804; 8

x, x, x, x, x, x, x, x&\#8805; 0

elde edilir.

Sekiz değişken ve &\#8804; işaretli iki kısıtlayıcı fonksiyondan oluşan
...
2y2 &\#8805; -6 ve -2y1 - 2y2 &\#8805; 6 olarak formüllenen ilk iki kısıt
yerine, 2y1 + 2y2 = -6, 3y1 + y2 &\#8805; 36 ve 3y1 - y2 &\#8805; -36 olarak
formüllenen üçüncü ve dördüncü kısıtların yerine, 3y1 + y2 = 36, y2 &\#8805; 66
ve -y2 &\#8805; -66 olarak formüllenen beşinci ve altıncı kısıtlayıcılar yerine
y2 = 66 yazılabilir. 6y1 + y2 &\#8805; 6 ve -6y1 - y2 &\#8805; -6 olarak
...
x1, x2 &\#8805; 0, x3 işareti kısıtlanmamış
...
kısıtlayıcı bulunacaktır. İkinci kısıtlayıcının işareti &\#8805; olduğundan ve
işareti kısıtlanmamış bir değişken bulunduğundan problem simetrik değildir.
Öncelikle simetrik biçimi oluşturalım. İşareti kısıtlanmamış x3 primal
değişkenin yerine, x- xyazalım. Problemde x3 = x- xkonulması ve &\#8805;
işaretli kısıtlayıcının -1 ile çarpılmasıyla,

Zenb = 8x1 + 15x2 + 17(x- x)

x1 + 3x2 + 6(x- x) &\#8804; 10

4x1 - 2x2 + 4(x- x) &\#8804; -15
...
x1 + 3x2 + 6x- 6x&\#8804; 10

4x1 - 2x2 + 4x- 4x&\#8804; -15

x1, x2, x, x&\#8805; 0

Dört değişken ve &\#8804; işaretli iki kısıtlayıcıya sahip düzenlenmiş primal
...
3y1 + 2y2 + y3 &\#8805; 40 3y1 + 2y2 + y3 - y4 + 0y5 + A1 + 0A2 = 40

2y1 + y2 + y3 &\#8805; 30 2y1 + y2 + y3 - 0y4 - y5 + 0A1 + A2 = 30

y1, y2, y3 &\#8805; 0 y1, y2, y3, y4, y5, A1, A2 &\#8805; 0
...
Dual değişken y1, aylak değişken x3’ü içeren 3x1 + 2x2 &\#8804; 30 primal
kısıtlayıcıya karşılık geldiğinden, y1 = Z3 - C3 olur. Primal problemin en iyi
çözümünde Z3 - C3 = 10’dur. Dolayısıyla y1 = 10 olur.

Dual değişken y2, x4 aylak değişkenini içeren 2x1 + x2 &\#8804; 18 primal
kısıtlayıcıya karşılık geldiğinden, y2 = Z4 - C4 olur. Primal problemin en iyi
çözümünde Z4 - C4 = 0’dır. Dolayısıyla, y1 = 0 olur.

Dual değişken y3, x5 aylak değişkenini içeren x1 + x2 &\#8804; 14 primal
kısıtlayıcıya karşılık geldiğinden y3 = Z5 - C5 olur. Primal problemin en iyi
çözümünde Z5 - C5 = 10’dur. Dolayısıyla, y3 = 10 olur.
...
x1, yapay değişkenli 3y1 + 2y2 + y3 &\#8805; 40 dual kısıtlayıcıya karşılık
geldiğinden, x1 = Z6 - C6 (M = 0) olur. Dual problemin en iyi çözümünde; Z6 - C6
= 2(M = 0) olduğundan, x1 = 2’dir.

x2, yapay değişkenli 2y1 + y2 + y3 &\#8805; 30 dual kısıtlayıcıya karşılık
geldiğinden, x2 = Z7 - C7 (M = 0) olur. Dual problemin en iyi çözümünde Z7 - C7
= 12(M = 0) olduğundan x2 = 12’dir.
...
Temel değişkenlerin hepsi &\#8805; 0 olduğundan, yürürlükteki en iyi çözüm yine
en iyidir. Değişen yalnızca temel değişkenlerin değerleridir. Bu değişiklikler
...
aşağıdaki gibi hesaplanacaktır. x5 &\#8804; 0 olduğundan en iyi çözüm, uygun
olma özelliğini yitirmiştir. Uygun en iyi çözüme ulaşmak için x5 temelden
çıkmalıdır.
...
Z6 - C6 &\#8804; 0 olduğundan, eldeki çözüm en iyi olma özelliğini yitirmiştir.
x6’yı temele alıp almama konusunda karar vermeden önce, x1, x2 ve x3
değişkenlerine karşılık gelen Zj - Cj değerlerinin de hesaplanması gerekir.
...
3y1 + 4y2 + 7y3 &\#8805; 16 olur. y1 = 44/53, y2 = 0, y3 = 81/53 olduğu dikkate
alındığında dual kısıtlayıcının sağlanmadığı (699/53 13.2 &\#8804; 16)
görülecektir. Bu durumda x2’ye karşılık gelen Z2 - C2 = 699/53 - 16 = -149/53
olur. Bu, en iyi çözüm tablosunun Zj - Cj satırında rastlanacak olan tek
değişikliktir ve x2’nin temele alınmasıyla en iyi çözüme ulaşılabilir.
...
katsayılarının değişmesi, Z2 - C2 değerinin değişmesine yol açar. Z2 - C2
&\#8805; 0 ise en iyi çözüm değişmez. Z2 - C2 &\#8804; 0 ise x2 temele alınarak
simpleks yöntemin bilinen işlemleri uygulanır.

x2’nin teknolojik katsayıları değiştiğinden, x2’ye karşılık gelen dual
kısıtlayıcı 6y1 + 4y2 + 10y3 &\#8805; 8 olur. Simpleks çarpanların değerleri
değişmediğinden,

Z2 - C2 = 6(308/371) + 4(0) + 10(3969/2597)] - 8 = 31850/2597

olarak hesaplanır. Z2 - C2 &\#8805; 0 olduğundan eldeki en iyi çözüm hala en
iyidir.
...
fonksiyon, 4y1 + 2y2 + y3 &\#8805; 2 olur. Simpleks çarpanların değişmediğini ve
y1 = 308/371, y2 = 0, y3 = 3969/2597 olduğunu hatırlayalım. Bu değerler yeni
dual kısıtlayıcıya konulduğunda,

4(308/371) + 2(0) + 1(3969/2597) = 12593/2597 ( 4.85) &\#8805; 2
...
fonksiyon, 4y1 + 2y2 + y3 &\#8805; 6 olur. y1 = 308/371, y2 = 0, y3 = 3969/2597
değerleri yeni kısıtlayıcıdaki yerlerine konulduğunda,

4(308/371) + 2(0) + 1(3969/2597) = 12593/2597 ( 4.85) &\#8804; 6

elde edilir. 4.85 &\#8804; 6 olduğundan, dual kısıtlayıcının sağlanmadığı, x4
...
**Örnek 2.30**: Örnek 2.22’deki primal probleme 2x1 + 3x2 + 7x3 &\#8804; 15
...
(18.4) &\#8805; 15 olarak belirlenecektir. Yürürlükteki çözüm yeni kısıtlayıcı
...
3x1 + 2x2 &\#8805; 15 2x1 + 4x2 &\#8805; 8 x1 + x2 &\#8805; 3

6x1 + 3x2 &\#8805; 6 x1 + x2 &\#8805; 1 -x1 + x2 &\#8805; 1

x1 &\#8805; 4 x1 - x2 &\#8805; -1 2x1 - x2 &\#8805; 1

x1, x2 &\#8805; 0 x1, x2 &\#8805; 0 x1, x2 &\#8805; 0

**d**. Zenb = 2x1 + x2 **e**. Zenk = 2x1 + 4x2 **f**. Zenk = x1 + 5x2

\-x1 + 2x2 &\#8805; 4 x1 + 2x2 &\#8805; 10 2x1 + x2 &\#8805; 6

x1 - 2x2 &\#8805; 4 x2 &\#8805; 4 5x1 + 4x2 &\#8805; 20

3x1 + x2 &\#8805; 6 x1 + x2 &\#8805; 1 x1 + x2 &\#8805; 6

x1, x2 &\#8805; 0 x1, x2 &\#8805; 0 x1, x2 &\#8805; 0

**g**. Zenb = 3x1 - 2x2 **h**. Zenb = 3x1 + 2x2 **i**. Zenb = 5x1 + 2x2

2x1 - x2 &\#8805; 10 5x1 + 2x2 &\#8805; 10 6x1 + x2 &\#8804; 6

6x1 - 3x2 &\#8805; 9 x1 + x2 &\#8805; 6 4x1 + x2 &\#8804; 10
...
2x1 + 3x2 &\#8804; 10 4x1 + 8x2 + 12x3 &\#8804; 20

4x1 + 6x2 &\#8804; 24 x1 + 9x2 + 3x3 &\#8804; 5

3x1 + 8x2 &\#8804; 40 4x1 + 8x2 + 12x3 &\#8804; 20

x1, x2 &\#8805; 0 x1, x2, x3 &\#8805; 0

**iii**. Zenb = 7x1 + 8x2 + 8x3 + 6x4 **iv**. Zenb = 3x1 + 4x2 + 6x3

2x1 - 3x2 + 6x3 - 3x4 &\#8804; 18 2x1 + x2 - 3x3 &\#8805; 12

4x1 + 6x2 + 5x4 &\#8804; 32 3x1 + 4x2 + 4x3 &\#8804; 14

3x1 + 8x2 + 4x3 &\#8804; 40 x1 - 6x2 + 9x3 &\#8804; 27

x1, x2, x3, x4 &\#8805; 0 x1, x2, x3 &\#8805; 0

**v**. Zenb = 18x1 + 36x2 + 18x3 **vı**. Zenk = 10x1 + 30x2

2x1 + 4x2 &\#8804; 10 3x1 + 4x2 &\#8805; 12

x1 + x2 + x3 &\#8805; 16 4x1 + 8x2 &\#8805; 20

2x1 + 3x2 + 4x3 = 18 x1 + x2 &\#8805; 8

x1, x2, x3 &\#8805; 0 x1, x2 &\#8805; 0

**vii**. Zenk = 2x1 + x2 - 2x3 - 3x4 **viii**. Zenb = 3x1 + 14x2 - 5x3 + 14x4

x1 + 3x2 + 3x3 + 4x4 = 4 x1 + 2x2 + 8x3 + x4 &\#8805; 4

2x1 + 5x2 + 7x3 + x4 = 5 2x1 + 6x2 + 2x3 + 3x4 &\#8804; 5

x1 + x2 + x3 = 6 4x1 + 5x2 + 9x3 = 20

x1, x2, x3, x4 &\#8805; 0 x1, x2, x3, x4 &\#8805; 0

**ix**. Zenk = 4x1 + 2x2 **x**. Zenk = 4x1 + 2x2 + 2x3 + x4

3x1 - 3x2 &\#8804; 2 3x1 - 3x2 + 4x3 + 2x4 &\#8804; 2

x1 + x2 &\#8804; 5 x1 + x2 + x3 + 3x4 &\#8804; 5

x1, x2 &\#8805; 0 x1, x2, x3, x4 &\#8805; 0

**14**. Zenb = 4x1 + 5x2 + 2x3 -3x4

4x1 + 2x2 + x3 &\#8804; 20

3x1 + 4x2 + x3 + 4x4 &\#8805; 10

4x1 + 5x2 + x3 + x4 = 12, x1, x2, x3, x4 &\#8805; 0
...
9.  Probleme 2x1 + 7x2 &\#8804; 10 kısıtlayıcısı eklenmektedir. Bu
    kısıtlayıcının eklenmesi yürürlükteki en iyi çözümü değiştirir mi?
    Açıklayınız.
